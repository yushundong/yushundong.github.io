...
* **Project Proposal (20%)**: There will be a semester-long project where the goal is to solve a challenging real-world data mining problem. Students will work in groups for this term project. Students will need to submit a project proposal outlining the project idea with <u>a hard deadline of 23:59 PM (ET) on October 4th, 2024</u>. This project proposal is strictly <u>two-page</u> for the main content, with unlimited pages of references and appendices, together with any type of supplementary materials under 50 MB. Grading will prefer those proposals with a smooth story-telling organization, a clear problem formulation, a succinct and straightforward tone, and a decent number of highly relevant references.  

* **Final Project Report & Presentation (50%)**: Students will need to submit a final report (**20% of final grades**) and the code with <u>a hard deadline of 23:59 PM (ET) on December 6th, 2024</u>. Only Python or MATLAB will be allowed for the implementations. Students will also be required to present their projects (**30% of final grades**) at the end of this semester: 11.25th, 12.2nd, 12.4th, and 12.9th (subject to changes depending on the final number of groups). Three slots will be assigned for each class in a random order among all groups. Each group will be given <u>20 minutes for presentation</u> and <u>3 minutes for Q&A</u> (23 minutes in total).
