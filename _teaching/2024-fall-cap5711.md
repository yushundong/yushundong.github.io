...
|   9.18 (Wednesday)   |    Artificial Neural Networks   |  [Artificial Neural Networks](https://drive.google.com/file/d/1XxcqURO4T9P2NzB9ru_Dq1lLZ2KJgWmY/view?usp=share_link)  |    |
| 9.23 (Monday) |    Artificial Neural Networks (cont.)     |  [Artificial Neural Networks (cont.)](https://drive.google.com/file/d/1yb_Pf0WE6BzhQtPdefnTuv8z1T-wGbMv/view?usp=share_link)  |                  |
|   9.25 (Wednesday)   |     Campus closed due to Hurricane Helene.     |              |                  |
| 9.30 (Monday) |  [Calculations in ANNs](https://drive.google.com/file/d/1oHknJuff36T5_06nEpImvtudINWa1li8/view?usp=sharing).    |              |    Artificial Neural Networks    |
|   10.2 (Wednesday)   |                               |              |   Rule-based Classifier  |
|       10.4        | 🚨 Proposal DDL at 23:59 PM (ET) |     N/A      | Not a class day. |
| 10.7 (Monday) |                               |              |   Rule-based Classifier   |
|   10.9 (Wednesday)   |                               |              | Nearest Neighbor Classifiers  |
| 10.14 (Monday) |                               |              |  Cluster Analysis   |
| 10.16 (Wednesday) |                               |              |  review session  |
| 10.21 (Monday) |                               |              |    review session   |
| 10.23 (Wednesday) |                               |              |  recitation session  |
| 10.28 (Monday) |                               |              | Cluster Analysis  |
| 10.30 (Wednesday) |                               |              |  Support Vector Machine   |
| 11.4 (Monday) |                               |              | Naïve Bayes Classifier  |
|   11.6 (Wednesday)   |                               |              | Ensemble Methods |
| 11.11 (Monday) |              N/A              |     N/A      |   🏖️ No class.     |
| 11.13 (Wednesday) |                               |              |  Ensemble Methods  |
| 11.18 (Monday) |                               |              |  Class Imbalance Problem  |
| 11.20 (Wednesday) |    **Paper presentation.**    |              |                  |
