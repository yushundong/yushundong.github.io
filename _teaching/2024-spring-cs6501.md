---
title: "CIS 4930/CAP 5771: Data Mining (Fall 2024)"
collection: teaching
...
## **Administrivia**
* :loudspeaker: **Instructor**: [**Dr. Yushun Dong**](https://yushundong.github.io) (yd24f[at]fsu[dot]edu)
* :bulb:**Teaching Assistants**: To be determined.
* :calendar: **Time**: Mondays & Wednesdays, 4:50 pm-6:05 pm (ET)
* :school: **Location**: [Classroom Building (HCB) Profile 216](https://map.concept3d.com/?id=1235#!ce/33184?m/345264?s/classroom?mc/30.44730676902374,-84.29711900000001?z/16?lvl/0?share)
* :mag_right: **Office Hour**: To be determined.
* :school_satchel: **Format**: In-person only (unless there is a drastic change in the situation).

## Course Overview
:rocket: Welcome to the fascinating field of data mining, a discipline at the intersection of computer science, statistics, and business intelligence! Throughout this course, we'll explore various data mining techniques, from classification and clustering to association analysis and anomaly detection. You'll learn how to prepare data, select appropriate algorithms, and interpret results. Real-world examples and case studies will illustrate the practical applications of data mining across diverse industries.  

:blue_book: This course will draw materials from the textbook and data mining and machine learning literature. Students will study the materials, complete written assignments, work on a course project, present their project in class, and take a final exam. Students are expected to have a working knowledge of basic probability theory and linear algebra. In addition, good programming skills are required for the course project. If you are not sure whether you have the right background, please contact the instructor.
...
* **Project Proposal (20%)**: There will be a semester-long project where the goal is to <u>solve a challenging real-world problem</u> or <u>propose frameworks/algorithms tackling a technical research problem</u>. Both will have paper submission potential. Students will work in groups for this term project. A project proposal will be due around the first week of October, outlining the project idea. This project proposal is strictly <u>one-page</u> for the main content, with unlimited pages of references and appendices, together with any type of supplementary materials under 50 MB. Grading will prefer those proposals with <u>a smooth story-telling organization</u>, <u>a clear problem formulation</u>, <u>a succinct and straightforward tone</u>, and <u>a decent number of highly relevant references</u>.  
