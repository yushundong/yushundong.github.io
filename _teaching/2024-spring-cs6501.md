...
📘 This course will draw materials from the textbook and data mining and machine learning literature. Students will study the materials, complete written assignments, work on a course project, present their project in class, and take a final exam. Students are expected to have a working knowledge of basic probability theory and linear algebra. In addition, good programming skills are required for the course project. If you are not sure whether you have the right background, please contact the instructor.
