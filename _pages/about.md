...
**Research Summary:** My research interest mainly lies in achieving responsible AI to further advance social good such as facilitating inclusive decision-making. I perform abundant research in related areas focusing on relational data, such as advancing the explainability, algorithmic fairness, and safety of deep learning. There are **27 published research papers (nine first author ones)** in the following areas [[see full list]](https://scholar.google.com/citations?hl=en&user=_QUhuOMAAAAJ):
